...
import { CreateRoleSchema, UpdateRoleSchema, AssignPermissionsSchema, AssignRoleToUserSchema, UserPermissionsSchema, RoleIdSchema, UserIdSchema, } from '../validators/role.schema';
...
export const assignPermissionsToRoleController = async (req, res, next) => {
    try {
        const { id } = RoleIdSchema.parse(req.params);
...
export const getAllPermissionsController = async (_req, res, next) => {
    try {
...
export const resetUserPermissionsController = async (req, res, next) => {
    try {
...
export const addUserPermissionsController = async (req, res, next) => {
    try {
        const { userId } = UserIdSchema.parse(req.params);
...
export const removeUserPermissionsController = async (req, res, next) => {
    try {
        const { userId } = UserIdSchema.parse(req.params);
        const { permissions } = UserPermissionsSchema.parse(req.body);
