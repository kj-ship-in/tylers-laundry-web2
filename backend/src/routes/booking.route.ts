...
router.get(
  '/my-bookings',
  requirePermission(Permission.BOOKING_VIEW_OWN),
  getBookingsByUserIdController,
);
router.post(
  '/create',
...
router.put(
  '/update/:id',
  requireOwnershipOrAdmin(
    _ => null, // TODO: Implement proper ownership check
...
router.get(
  '/getAll',
  requirePermission(Permission.BOOKING_VIEW_ALL),
  getAllBookingsController,
);
router.patch(
  '/update-status/:id',
  requirePermission(Permission.BOOKING_UPDATE_STATUS),
  updateBookingStatusController,
);
router.delete(
  '/delete/:id',
  requirePermission(Permission.BOOKING_DELETE),
  deleteBookingController,
);
router.post(
  '/admin/create-for-client',
  requirePermission(Permission.BOOKING_CREATE_FOR_CLIENT),
  adminCreateBookingController,
);
