...
import {
  ...
  getAllAdminTestimonialsController,
...
router.post(
  ...
  requirePermission(Permission.TESTIMONIAL_CREATE),
  createTestimonialController,
);
...
router.put(
  ...
  requirePermission(Permission.TESTIMONIAL_UPDATE),
  updateTestimonialController,
);
...
router.delete(
  '/delete/:id',
  validateParams(TestimonialIdSchema),
  requirePermission(Permission.TESTIMONIAL_DELETE),
  deleteTestimonialController,
);
