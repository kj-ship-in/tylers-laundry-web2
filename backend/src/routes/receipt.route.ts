...
router.post(
  '/create',
  requirePermission(Permission.RECEIPT_GENERATE),
  createReceiptController,
);
router.get(
  '/getAll',
  requirePermission(Permission.RECEIPT_VIEW_ALL),
  getAllReceiptsController,
);
router.get(
  '/get/:id',
...
router.put(
  '/update/:id',
  requirePermission(Permission.RECEIPT_UPDATE),
  updateReceiptController,
);
router.delete(
  '/delete/:id',
  requirePermission(Permission.RECEIPT_DELETE),
  deleteReceiptController,
);
...
router.get(
  '/pdf/:id',
  requirePermission(Permission.PDF_GENERATE_RECEIPT),
  generateReceiptPDFController,
);
