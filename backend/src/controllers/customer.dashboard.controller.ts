...
export const getCustomerDashboardStatsController = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<any> => {
...
export const getCustomerRecentBookingsController = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<any> => {
...
export const getCustomerUpcomingBookingsController = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<any> => {
