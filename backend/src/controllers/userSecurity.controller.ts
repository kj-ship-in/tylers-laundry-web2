...
import {
  ...
  createPinService,
  changePinService,
  enableBiometricsService,
} from '../services/userSecurity.service';
import {
  ChangePasswordSchema,
  CreatePinSchema,
  ChangePinSchema,
  EnableBiometricsSchema,
} from '../validators/user.security.schema';
...
export const createPinController = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<any> => {
...
export const enableBiometricsController = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<any> => {
